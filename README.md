...
The action supports creating domain aliases that are based on the main host. This is useful when you need multiple domains pointing to the same review app (e.g., for testing different language subdomains or www variants).
